...
(function($) {
  $(function() {
    ...
    setTimeout(console.log.bind(console, `%cInitiating WooCommerce Attributes Easy-Search [developed by https://amirhp.com ]`, consloe));
    ...
    function initEasySearch() {
      setTimeout(console.log.bind(console, `%cRe-initiating WooCommerce Attributes Easy-Search [developed by https://amirhp.com ]`, consloe));
